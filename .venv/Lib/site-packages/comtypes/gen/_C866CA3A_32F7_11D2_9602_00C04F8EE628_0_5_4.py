...
__all__ = [
    'DISPID_SLWWord', 'DISPID_SRCEAudioLevel', 'ISpeechAudio',
    'ISpeechPhoneConverter', 'DISPID_SASCurrentSeekPosition',
    'SVPNormal', 'SAFT24kHz8BitMono', 'SGDSActiveWithAutoPause',
    'SpWaveFormatEx', 'DISPID_SPIProperties', 'SDKLDefaultLocation',
    'DISPID_SRRAlternates', 'DISPID_SpeechLexiconWord',
    'SPSEMANTICFORMAT', 'DISPID_SOTsCount',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVSPhonemeId',
    'DISPID_SPAPhraseInfo', 'SpFileStream', 'eLEXTYPE_PRIVATE12',
    'SpeechRecognizerState', 'ISpeechLexiconWords',
    'STSF_CommonAppData', 'DISPID_SGRs_NewEnum',
    'ISpeechPhraseElements', 'SPRECORESULTTIMES', 'SPSUnknown',
    'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_9', 'tagSTATSTG',
    'SPXMLRESULTOPTIONS', 'SpeechTokenIdUserLexicon',
    'SPEI_END_SR_STREAM', 'SpeechAudioFormatGUIDText',
    'SPEI_REQUEST_UI', 'SVP_3', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPEAudioSizeTime', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPWAVEFORMATTYPE', 'SAFTADPCM_22kHzStereo',
    'DISPID_SDKDeleteValue', 'SpeechVoiceCategoryTTSRate',
    'SPAS_CLOSED', 'SVF_None', 'SPPHRASEREPLACEMENT',
    'DISPID_SRCCreateGrammar', 'SREPrivate',
    'DISPID_SpeechPhraseElements', 'SASStop', 'SFTSREngine',
    'SP_VISEME_0', 'DISPID_SPRuleName', 'DISPID_SASState',
    'DISPID_SASNonBlockingIO', '_RemotableHandle', 'SP_VISEME_18',
    'SPEVENTSOURCEINFO', 'DISPID_SDKGetBinaryValue', 'SVEPhoneme',
    'SREStreamStart', 'SPWF_INPUT',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechGrammarRuleStateTransitions', 'SPCONTEXTSTATE',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_RESERVED9', 'ISpeechCustomStream',
    'SRAORetainAudio', 'SP_VISEME_3', 'DISPID_SRCEHypothesis',
    'SVSFVoiceMask', 'SpeechAudioVolume', 'DISPID_SOTCId',
    'DISPID_SFSClose', 'SpeechDisplayAttributes',
    'DISPID_SPELexicalForm', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRsFindRule', 'SPPS_NotOverriden', 'DISPID_SWFEChannels',
    'eLEXTYPE_RESERVED10', 'DISPID_SPPConfidence',
    'SPEI_TTS_AUDIO_LEVEL', 'SREStateChange', 'SPPS_SuppressWord',
    'DISPID_SPRsCount', 'ISpRecognizer2', 'DISPID_SGRsCommit',
    'SREAdaptation', 'SP_VISEME_4', 'SPPHRASE',
    'SpeechBookmarkOptions', 'SpeechVoiceSkipTypeSentence',
    'SPFILEMODE', 'eLEXTYPE_PRIVATE6', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechCustomStream', 'SAFTADPCM_8kHzMono',
    'DISPID_SPILanguageId', 'DISPID_SRCreateRecoContext',
    'DISPID_SpeechPhraseProperty', 'ISpeechLexicon',
    'DISPID_SOTIsUISupported', 'SAFT11kHz8BitMono',
    'DISPID_SRCEPropertyStringChange', 'SASRun', 'STCInprocServer',
    'SECHighConfidence', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechAudioStatus', 'SPVOICESTATUS',
    'SpeechCategoryAudioOut', 'SpeechGrammarRuleStateTransitionType',
    'SVF_Stressed', 'SPGRAMMARSTATE', 'DISPID_SRCEventInterests',
    'DISPID_SAEventHandle', 'SVSFIsFilename', 'SPWORD', 'SRSEDone',
    'DISPID_SPEAudioTimeOffset', 'SPPS_RESERVED4',
    'DISPID_SWFEExtraData', 'SPEI_RESERVED1',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRDisplayUI', 'SVP_19',
    'SPSHT_EMAIL', 'DISPID_SGRInitialState', 'DISPID_SGRSTText',
    'SPGS_DISABLED', 'SAFTGSM610_8kHzMono', 'SINoSignal',
    'SpeechRecognitionType', 'SVESentenceBoundary',
    'DISPID_SRCCmdMaxAlternates', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCState', 'DISPID_SVSInputSentencePosition',
    'SpAudioFormat', 'SpeechInterference',
    'DISPID_SAFSetWaveFormatEx', 'DISPIDSPTSI_ActiveLength',
    'SAFT11kHz8BitStereo', 'Speech_StreamPos_Asap',
    'DISPID_SVSInputWordPosition', 'SpMMAudioIn',
    'DISPID_SMSADeviceId', 'SBOPause', 'DISPID_SOTCGetDataKey',
    'SRAInterpreter', 'SPSHORTCUTTYPE', 'DISPID_SPEActualConfidence',
    'SVSFlagsAsync', 'DISPID_SVEStreamEnd',
    'DISPID_SDKSetBinaryValue', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SGRsAdd', 'SpPhoneConverter', 'SRERecoOtherContext',
    'SVP_6', 'SAFT48kHz16BitMono', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRAddResource', 'SPEI_SENTENCE_BOUNDARY', 'SVSFNLPMask',
    'SPPHRASEELEMENT', 'DISPID_SRCEPropertyNumberChange',
    'SPPARTOFSPEECH', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPINTERFERENCE_NONE',
    'eLEXTYPE_PRIVATE19', 'SGRSTTDictation', 'SAFT12kHz16BitMono',
    'SpeechPropertyAdaptationOn', 'ISpeechPhraseRules',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SMSSetData',
    'SPVPRIORITY', 'ISpDataKey', 'ISpObjectWithToken', 'SPXRO_SML',
    'DISPID_SDKSetLongValue', 'SpPhraseInfoBuilder',
    'DISPID_SPPNumberOfElements', 'SREBookmark', 'SP_VISEME_16',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechMMSysAudio',
    'SpeechVoicePriority', 'DISPID_SLWType', 'ISpRecoContext2',
    'SAFTCCITT_ALaw_11kHzMono', 'SVSFIsNotXML', 'DISPID_SVEWord',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SECFEmulateResult',
    'SpMemoryStream', 'SVP_13', 'SAFT11kHz16BitStereo', 'SVSFDefault',
    'eLEXTYPE_PRIVATE9', 'SPAR_Unknown', 'SPAO_NONE',
    'eLEXTYPE_RESERVED4', 'ISpeechLexiconWord', 'DISPID_SRGRules',
    'DISPID_SRCERecognizerStateChange',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_USER',
    'SECFNoSpecialChars', 'SGLexical', 'SpeechDataKeyLocation',
    'DISPID_SpeechPhraseReplacements', 'SVP_12', 'SGSExclusive',
    ...
    'DISPID_SRRGetXMLResult', 'SPAUDIOSTATE', 'SSFMOpenForRead',
    'DISPID_SPACommit', 'tagSPPROPERTYINFO', 'SPSVerb',
    'ISpeechRecoResult2', 'eLEXTYPE_PRIVATE3', 'DISPID_SRCRecognizer',
    'SAFT24kHz16BitMono', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPRulesItem',
    'DISPIDSPTSI_SelectionLength', 'SPPHRASERULE',
    'DISPID_SDKGetlongValue', 'DISPID_SRGCmdLoadFromFile',
    'SPEI_WORD_BOUNDARY', 'SpTextSelectionInformation',
    'DISPID_SVPause', 'DISPID_SVStatus', 'SVP_15',
    'DISPID_SpeechRecoContextEvents', 'SPAR_Low',
    'DISPID_SPIEngineId', 'DISPID_SRRTOffsetFromStart', 'SVP_4',
    'SREPropertyNumChange', 'SGDSActive', 'DISPID_SpeechObjectToken',
    'SVEViseme', 'DISPID_SRGCmdLoadFromResource',
    'SAFT22kHz16BitStereo', 'DISPID_SPPsItem', 'SAFT16kHz8BitStereo',
    'DISPID_SVEBookmark', 'DISPID_SVEEnginePrivate',
    'SpeechTokenShellFolder', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechRecoResult', 'SpeechPropertyResourceUsage',
    'DISPID_SOTCategory', 'DISPID_SASetState',
    'DISPID_SPRNumberOfElements', 'SSTTTextBuffer',
    'DISPID_SRSClsidEngine', 'ISpPhoneticAlphabetSelection',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRState', 'SREStreamEnd',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE5',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRRAudioFormat',
    'ISpeechPhraseElement', 'DISPID_SRCRequestedUIType',
    'SpeechStreamFileMode', 'DISPID_SpeechPhoneConverter',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SSTTDictation',
    'DISPID_SRGIsPronounceable', 'DISPID_SGRsDynamic',
    'ISpeechAudioFormat', 'SSFMCreateForWrite', 'SpInprocRecognizer',
    'DISPID_SPEsCount', 'SpeechRunState',
    'SpeechPropertyHighConfidenceThreshold', 'SVEWordBoundary',
    'DISPID_SGRsCount', 'SVSFParseSsml', 'SPEVENT', 'DISPID_SVSpeak',
    'DISPID_SRRTStreamTime', 'SpeechEngineConfidence', 'SDTRule',
    'SPSERIALIZEDRESULT', 'SPFM_NUM_MODES', 'DISPID_SRGState',
    'DISPID_SpeechPhraseRule', 'SVSFParseAutodetect', 'SLTUser',
    'SRTStandard', 'ISpAudio', 'DISPID_SPEPronunciation',
    'DISPID_SPIRule', 'SGRSTTRule', 'ISpeechPhraseAlternate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpResourceManager',
    'SECFDefault', 'SPAUDIOSTATUS', 'SVSFUnusedFlags',
    'DISPID_SPRuleChildren', 'DISPID_SPISaveToMemory',
    'SPRST_INACTIVE', 'SPVPRI_OVER', 'DISPID_SVEventInterests',
    'ISpeechDataKey', 'DISPID_SPIGetText', 'SLODynamic',
    'DISPID_SABufferInfo', 'DISPID_SVSLastBookmarkId',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SLWLangId', 'SP_VISEME_6',
    'DISPID_SPEDisplayText', 'DISPID_SPEDisplayAttributes',
    'DISPID_SBSRead', 'DISPID_SWFEAvgBytesPerSec', 'SVSFNLPSpeakPunc',
    'SWPUnknownWordPronounceable',
    'DISPID_SpeechLexiconPronunciation', 'SpeechVoiceSpeakFlags',
    'SPBOOKMARKOPTIONS', 'SpeechWordPronounceable',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechObjectTokens', 'SpShortcut',
    'SPWORDPRONUNCIATION', 'SpeechAudioState', 'SBONone',
    'SPLOADOPTIONS', 'SVSFParseMask', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE4', 'SPWORDTYPE', 'SDTReplacement',
    'DISPID_SLPSymbolic', 'SpeechStreamSeekPositionType',
    'SAFT44kHz16BitStereo', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRRTimes', 'IEnumSpObjectTokens', 'SPEI_MAX_SR',
    'DISPID_SLWs_NewEnum', 'SDTPronunciation',
    'DISPID_SpeechGrammarRule', 'ISpeechRecognizerStatus',
    'DISPID_SLWsCount', 'ISpGrammarBuilder',
    'DISPID_SPIAudioSizeBytes', 'SSTTWildcard', 'DISPID_SPAsCount',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_RESERVED6',
    'SpeechRetainedAudioOptions', 'DISPID_SOTCreateInstance',
    'DISPID_SOTCSetId', 'DISPID_SPIGetDisplayAttributes',
    'SGSEnabled', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_PRIVATE2', 'SPEI_PHONEME',
    'ISpNotifySink', 'SRSEIsSpeaking', 'STSF_LocalAppData',
    'SPPS_Interjection', 'DISPID_SGRAttributes',
    'DISPID_SRGDictationLoad', 'SPSHORTCUTPAIRLIST',
    'SAFTCCITT_ALaw_22kHzMono', 'SPEI_MIN_SR', 'SpCustomStream',
    'SPSLMA', 'SSSPTRelativeToStart', 'ISpRecognizer3',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRRecognizer',
    'SPEI_SOUND_START', 'SPSFunction', 'SAFT44kHz16BitMono',
    'DISPID_SRRSaveToMemory', 'DISPID_SPIGrammarId',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPEAudioSizeBytes', 'SpObjectToken', 'ISpXMLRecoResult',
    'ISpeechLexiconPronunciations', 'SAFT8kHz8BitStereo',
    'SGDSActiveUserDelimited', 'DISPID_SRRTLength',
    'DISPID_SPIElements', 'SRTExtendableParse', 'SDTProperty',
    'eWORDTYPE_ADDED', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRSNumberOfActiveRules', 'SAFT32kHz16BitStereo',
    'SITooFast', 'SVP_14', 'SRTReSent', 'SPPROPERTYINFO',
    'SPRULESTATE', 'SRTSMLTimeout', 'SRAExport', 'DISPID_SPPName',
    'DISPID_SVWaitUntilDone', 'ISpShortcut',
    'DISPID_SLGetGenerationChange', 'SVP_1',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFT11kHz16BitMono', 'SPWT_DISPLAY', 'SpMMAudioOut',
    'DISPID_SRRAudio', 'DISPID_SpeechDataKey',
    'DISPID_SPERequiredConfidence', 'SPEI_RECO_STATE_CHANGE',
    'SpeechPropertyLowConfidenceThreshold', 'SPSSuppressWord',
    'SP_VISEME_14', 'SPEI_HYPOTHESIS', 'SpMMAudioEnum',
    'DISPID_SABIMinNotification', 'SGDisplay', 'eLEXTYPE_RESERVED7',
    'SRERequestUI', 'SVP_20', 'DISPID_SpeechGrammarRuleState',
    'SAFT48kHz8BitMono', 'DISPID_SRCSetAdaptationData', 'SAFTDefault',
    'SpeechRuleState', 'SSFMOpenReadWrite',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechRecoResult2', 'SINone',
    'SP_VISEME_13', 'SpeechDiscardType', 'SpSharedRecognizer',
    'SP_VISEME_7', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechEngineProperties', 'SVP_11', 'SP_VISEME_20',
    'DISPID_SRAudioInput', 'STCAll', 'SPCT_SUB_DICTATION',
    'DISPID_SPRuleParent', 'SRESoundEnd',
    'DISPID_SPRDisplayAttributes', 'SAFT16kHz16BitMono', 'Library',
    'DISPID_SRCEEnginePrivate', 'SpeechCategoryRecoProfiles',
    'SVEVoiceChange', 'SP_VISEME_11', 'DISPID_SVDisplayUI',
    'DISPID_SPRuleId', 'SPAR_High', 'SDKLLocalMachine',
    'DISPID_SRSAudioStatus', 'SPINTERFERENCE_TOOQUIET', 'SPRULE',
    'SAFT44kHz8BitMono', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEAdaptation',
    'SGDSInactive', 'SPSNoun', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRCVoice', 'ISpVoice', 'SPAUDIOOPTIONS', 'SP_VISEME_2',
    'DISPID_SpeechMemoryStream', 'SAFTNoAssignedFormat',
    'SPGS_ENABLED', 'DISPID_SRGetPropertyNumber', 'DISPID_SLPsItem',
    'SAFTADPCM_11kHzStereo', 'SRCS_Disabled', 'SpeechVisemeType',
    'SPSNotOverriden', 'SpeechTokenKeyUI', 'SPPS_RESERVED1',
    'SITooLoud', 'DISPID_SVEPhoneme', 'eLEXTYPE_PRIVATE14',
    'SpeechTokenValueCLSID', 'DISPID_SRGRecoContext', 'SASClosed',
    ...
    'DISPID_SOTs_NewEnum', 'SPINTERFERENCE', 'SGRSTTWord',
    'DISPID_SVEVoiceChange', 'DISPID_SGRSRule',
    'ISpeechXMLRecoResult', 'DISPID_SPARecoResult',
    'DISPID_SRRTTickCount', 'SVEAudioLevel',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechTextSelectionInformation', 'eLEXTYPE_VENDORLEXICON',
    'SPSTREAMFORMATTYPE', 'ISpLexicon', 'DISPID_SRSetPropertyNumber',
    'SECLowConfidence', '_SPAUDIOSTATE', 'DISPID_SDKEnumKeys',
    'DISPID_SRGId', 'SDA_Consume_Leading_Spaces', 'ISpEventSink',
    'DISPID_SGRSAddSpecialTransition', 'SpNotifyTranslator',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SABIBufferSize',
    'DISPID_SOTCDefault', 'ISpObjectToken',
    'SpeechCategoryAppLexicons', 'eWORDTYPE_DELETED',
    'SECFIgnoreWidth', 'SPPS_Noncontent', 'DISPID_SMSGetData',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpVoice', 'DISPID_SRIsUISupported',
    'DISPID_SOTRemove', 'DISPID_SBSWrite', 'DISPID_SDKCreateKey',
    'DISPID_SRStatus', 'SVF_Emphasis', 'ISpRecoGrammar2',
    'DISPID_SPPsCount', 'DISPID_SPCIdToPhone', 'SVPAlert',
    'SAFT44kHz8BitStereo', 'SAFTADPCM_8kHzStereo',
    'SAFT12kHz16BitStereo', 'DISPID_SPPId', 'SPSMF_SAPI_PROPERTIES',
    'SAFTCCITT_uLaw_22kHzMono', 'SPCATEGORYTYPE', 'SPGRAMMARWORDTYPE',
    'SP_VISEME_5', 'ISpeechWaveFormatEx', 'ISpeechPhraseAlternates',
    'DISPID_SVVolume', 'DISPID_SpeechPhraseRules', 'SpeechLoadOption',
    'SpUnCompressedLexicon', 'DISPID_SRRRecoContext',
    'SPRECOCONTEXTSTATUS',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSCurrentStreamNumber', 'SpeechFormatType',
    'DISPID_SVAudioOutputStream', 'ISpeechFileStream',
    'SpeechEmulationCompareFlags', 'SAFTText',
    'DISPID_SRSetPropertyString', 'DISPID_SLPs_NewEnum',
    'SPTEXTSELECTIONINFO', 'SpeechTokenContext', 'STCRemoteServer',
    'DISPID_SABIEventBias', 'SPCS_DISABLED',
    'DISPID_SLWPronunciations', 'DISPID_SRGetFormat',
    'DISPID_SPRulesCount', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SWFEFormatTag', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_PRIVATE8', 'STSF_AppData', 'DISPID_SpeechLexiconWords',
    'LONG_PTR', 'ISpPhraseAlt', 'DISPID_SRCESoundStart',
    'SPEI_MAX_TTS', 'eLEXTYPE_PRIVATE18', 'DISPID_SPEsItem',
    'ISpeechPhraseReplacement', 'DISPID_SABufferNotifySize',
    'SREAllEvents', 'ISpeechVoice', 'DISPID_SVAudioOutput',
    'SPPS_RESERVED2', 'DISPID_SpeechPhraseElement',
    'SAFT22kHz8BitMono', 'DISPID_SPRsItem', 'SPEI_SR_PRIVATE',
    'SVP_7', 'SRARoot', 'DISPID_SVSInputWordLength',
    'SPWORDPRONOUNCEABLE', 'DISPID_SBSFormat', 'SpResourceManager',
    'SAFT12kHz8BitMono', 'SAFT32kHz16BitMono',
    'DISPID_SPERetainedSizeBytes', 'SRATopLevel', 'IEnumString',
    'DISPID_SpeechXMLRecoResult', 'SPEI_VISEME',
    ...
    'SpeechMicTraining', 'DISPID_SpeechPhraseAlternates',
    'SPPS_RESERVED3', 'SAFTADPCM_44kHzStereo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SDKDeleteKey',
    'SPSInterjection', 'SpeechRuleAttributes',
    'DISPIDSPTSI_SelectionOffset', 'SAFT22kHz8BitStereo',
    'SAFT16kHz16BitStereo', 'SPVPRI_ALERT', 'SP_VISEME_12',
    'SPRECOGNIZERSTATUS', 'DISPID_SpeechRecoContext', 'DISPIDSPTSI',
    'ISpNotifyTranslator', 'SPGS_EXCLUSIVE', 'SPEI_RESERVED2',
    'ISpeechRecoResultTimes', 'DISPID_SGRClear',
    'DISPID_SLPPartOfSpeech', 'DISPID_SLGetPronunciations',
    'DISPID_SGRSTsCount', 'SPEI_VOICE_CHANGE',
    'DISPID_SRGCmdLoadFromObject', 'SPWORDLIST', 'SAFT8kHz8BitMono',
    'SpeechRecoContextState', 'SpInProcRecoContext', 'SRAONone',
    'SPAS_STOP', 'SpeechGrammarTagUnlimitedDictation',
    'ISpeechRecoResultDispatch', 'DISPID_SPRuleEngineConfidence',
    'SRAImport', 'DISPID_SVSRunningState', 'ISpeechRecoGrammar',
    'SPRS_ACTIVE', 'SAFT24kHz16BitStereo', 'DISPID_SAFGuid',
    'DISPID_SRCEPhraseStart', 'SPAO_RETAIN_AUDIO',
    'SAFT32kHz8BitStereo', 'SRCS_Enabled', 'SPDATAKEYLOCATION',
    'STSF_FlagCreate', 'DISPID_SAFGetWaveFormatEx', 'SDTDisplayText',
    'SpeechRecoProfileProperties', 'SPRECOSTATE', 'SPEI_ADAPTATION',
    'SINoise', 'SPRST_INACTIVE_WITH_PURGE', 'SPCT_COMMAND',
    'SpPhoneticAlphabetConverter', 'SPVPRI_NORMAL', 'SVSFIsXML',
    'DISPID_SGRAddState', 'DISPID_SPPEngineConfidence',
    'ISpeechRecoResult', 'SPFM_CREATE', 'DISPID_SAFType',
    'SVEBookmark', 'ISpeechBaseStream', 'eLEXTYPE_USER_SHORTCUT',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTDisplayUI', 'DISPID_SBSSeek',
    'SVP_5', 'DISPID_SRRDiscardResultInfo', 'SPCT_SLEEP',
    'SAFT48kHz16BitStereo', 'ISpeechAudioStatus',
    'DISPID_SPPs_NewEnum', 'SP_VISEME_1', 'SREHypothesis',
    'ISpStream', 'DISPID_SpeechObjectTokenCategory',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFT32kHz8BitMono', 'SVP_10',
    'SPPS_Verb', 'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRCEEndStream',
    'SpeechCategoryRecognizers', 'ISpeechGrammarRule',
    'DISPID_SDKEnumValues', 'SGLexicalNoSpecialChars',
    'SPWT_PRONUNCIATION', 'DISPID_SGRSTNextState', 'WAVEFORMATEX',
    'SPPS_Unknown', 'SPRS_INACTIVE', 'DISPID_SMSALineId',
    'SP_VISEME_15', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVSVisemeId', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SOTGetStorageFileName',
    'SpStreamFormatConverter', 'SVP_8', 'SDKLCurrentConfig',
    'SDA_No_Trailing_Space', 'SDA_Two_Trailing_Spaces',
    'SPFM_OPEN_READONLY', 'SPFM_OPEN_READWRITE', 'SpeechVoiceEvents',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPRuleConfidence', 'DISPID_SAVolume',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRName', 'SITooQuiet',
    'DISPIDSPTSI_ActiveOffset', 'ISpProperties',
    'DISPID_SPIReplacements', 'ISpeechPhraseRule',
    'DISPID_SOTCEnumerateTokens', 'SpeechCategoryAudioIn',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVPOver', 'SDTAudio',
    'SAFTGSM610_44kHzMono', 'SECFIgnoreCase', 'SPEI_PHRASE_START',
    'SPRST_NUM_STATES', 'SDTLexicalForm', 'SpeechAllElements',
    'DISPID_SGRSTransitions', 'SRERecognition', 'SPEI_MIN_TTS',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPPChildren',
    'ISpRecoContext', 'SPPS_LMA', 'SPDKL_DefaultLocation', 'SpStream',
    'SVEEndInputStream', 'SVP_9', 'SPSModifier',
    'SAFT48kHz8BitStereo', 'STCLocalServer', 'DISPID_SPPValue',
    'ISpeechMemoryStream', 'SRSActive', 'SPEI_TTS_PRIVATE',
    'SpeechAudioProperties', 'SRSInactiveWithPurge',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechAudioFormatGUIDWave', 'ISpSerializeState',
    'ISpeechVoiceStatus', 'SITooSlow', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechTokenKeyAttributes', 'DISPID_SGRSTWeight',
    '_ISpeechVoiceEvents', 'DISPID_SRGetPropertyString',
    'DISPID_SGRSTPropertyId', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SpeechMMSysAudio', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPXRO_Alternates_SML', 'DISPID_SPRFirstElement', 'UINT_PTR',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRCBookmark', 'DISPID_SRCERecognitionForOtherContext',
    'SRTAutopause', 'SPWF_SRENGINE', 'SpeechRegistryLocalMachineRoot',
    'SpLexicon', 'SPAS_PAUSE', 'DISPID_SLPsCount', 'SREPhraseStart',
    'DISPID_SVEViseme', 'DISPID_SGRSTPropertyName',
    'SAFT8kHz16BitMono', 'DISPID_SRGDictationSetState',
    'DISPID_SGRsItem', 'DISPID_SRCPause', 'SVEAllEvents',
    'DISPID_SRRPhraseInfo', 'DISPID_SVEAudioLevel',
    'DISPID_SMSAMMHandle', 'SRSActiveAlways', 'ISpRecoResult',
    'DISPID_SRGCmdLoadFromMemory', 'SPEVENTENUM',
    'SVSFPurgeBeforeSpeak', 'SpeechGrammarTagDictation',
    'eLEXTYPE_PRIVATE20', 'ISpeechResourceLoader',
    'DISPID_SGRSTs_NewEnum', 'SECFIgnoreKanaType', 'DISPID_SRGCommit',
    'SAFTCCITT_uLaw_44kHzMono', 'SPBO_PAUSE', 'SGRSTTWildcard',
    'SPSHT_OTHER', 'DISPID_SCSBaseStream',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SpeechFileStream',
    'DISPID_SpeechGrammarRuleStateTransitions',
    '__MIDL_IWinTypes_0009', 'SPEI_UNDEFINED',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTGetDescription',
    'DISPID_SVSLastResult', 'ISpeechLexiconPronunciation', 'SVP_21',
    'DISPID_SRGSetTextSelection', 'DISPID_SASCurrentDevicePosition',
    'ISpObjectTokenCategory', 'DISPID_SRGCmdSetRuleState',
    'SDA_One_Trailing_Space', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPBO_NONE', 'SpObjectTokenCategory', 'SREAudioLevel',
    'SREPropertyStringChange', 'ISpeechObjectTokens',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRSAddWordTransition',
    'DISPID_SLGenerationId', 'DISPID_SPIStartTime',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRSpeakAudio', 'DISPID_SPRText',
    'SPEI_TTS_BOOKMARK', 'SVSFParseSapi', 'eLEXTYPE_APP',
    'DISPID_SVGetVoices', 'DISPID_SVSpeakStream',
    'Speech_StreamPos_RealTime', 'SAFTADPCM_11kHzMono',
    'DISPID_SGRSTRule', 'DISPID_SRCResume', 'DISPID_SLGetWords',
    'DISPID_SFSOpen', 'SAFT8kHz16BitStereo', 'ISpeechObjectToken',
    'ISpRecognizer', 'DISPID_SPEEngineConfidence', 'STCInprocHandler',
    'SVP_16', 'ISpeechGrammarRuleState', 'SPEI_RESERVED5',
    'SPSEMANTICERRORINFO', 'SPDKL_CurrentUser', 'SAFT12kHz8BitStereo',
    'SPPS_Function', 'DISPID_SVIsUISupported', 'ISpPhoneConverter',
    'SpeechRegistryUserRoot', 'SPEI_SOUND_END',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SLAddPronunciation',
    'SGRSTTTextBuffer', '_ISpeechRecoContextEvents',
    'DISPID_SPPParent', 'ISpeechObjectTokenCategory',
    'DISPID_SRSCurrentStreamNumber', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPFirstElement', 'DISPID_SRGReset', 'eLEXTYPE_PRIVATE15',
    'DISPID_SLPType', 'DISPID_SWFEBlockAlign', 'SAFTADPCM_44kHzMono',
    'SPEI_INTERFERENCE', 'SWPUnknownWordUnpronounceable',
    'DISPID_SVResume', 'SPAS_RUN', 'DISPID_SRCERecognition',
    'eLEXTYPE_MORPHOLOGY', 'SPBO_AHEAD', 'SVEStartInputStream',
    'ISpeechPhraseProperty', 'SAFTCCITT_uLaw_22kHzStereo',
    'IInternetSecurityMgrSite', 'eLEXTYPE_PRIVATE11', 'SVP_18',
    'SpeechCategoryVoices',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SDKGetStringValue', 'SPBO_TIME_UNITS',
    'DISPID_SRGSetWordSequenceData', 'Speech_Default_Weight',
    'SPEI_RESERVED6', 'ISpStreamFormat', 'SWTDeleted',
    'ISpeechGrammarRuleStateTransition', 'SpeechGrammarState',
    'DISPID_SVESentenceBoundary', 'Speech_Max_Pron_Length',
    'SPLEXICONTYPE', 'DISPID_SGRId', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechVoiceEvent', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpeechRecognizer', 'DISPID_SLPLangId',
    'SAFTCCITT_ALaw_8kHzMono', 'SREInterference',
    'SPSHT_NotOverriden', 'SAFTCCITT_ALaw_44kHzMono', 'SWTAdded',
    'DISPID_SOTSetId', 'SPVISEMES', 'DISPID_SRCRetainedAudioFormat',
    'SGSDisabled', 'ISpeechPhraseInfo', 'eLEXTYPE_PRIVATE16',
    'SPLO_DYNAMIC', 'SPADAPTATIONRELEVANCE', 'SpeechAudioFormatType',
    'SSSPTRelativeToEnd', 'SWPKnownWordPronounceable',
    'DISPID_SPERetainedStreamOffset', 'SRTEmulated',
    'DISPID_SRGCmdSetRuleIdState', 'ISpPhrase',
    'SpeechCategoryPhoneConverters', 'DISPID_SAStatus',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SLRemovePronunciation',
    'SPAR_Medium', 'SAFT24kHz8BitStereo', 'SVP_2',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SREmulateRecognition',
    'SPSMF_UPS', 'DISPID_SGRSTsItem', 'SGRSTTEpsilon', 'SP_VISEME_17',
    'DISPID_SLPPhoneIds', 'DISPID_SpeechLexiconProns',
    'SPRST_ACTIVE_ALWAYS', 'SVP_0', 'SDTAll', 'DISPID_SVPriority',
    'IInternetSecurityManager', 'SPEI_START_SR_STREAM',
    'DISPID_SRGDictationUnload', 'DISPID_SPCPhoneToId',
    'DISPID_SLWsItem', 'ISpStreamFormatConverter', 'SPRST_ACTIVE',
    'SPEI_RECOGNITION', 'SPCS_ENABLED', 'SAFT22kHz16BitMono',
    ...
    'SAFTExtendedAudioFormat', 'SFTInput',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechUserTraining',
    'eLEXTYPE_PRIVATE1', 'SP_VISEME_21', 'ISpEventSource',
    'SAFTGSM610_11kHzMono', 'SPPS_Noun', 'SpeechPartOfSpeech',
    'SP_VISEME_8', 'SPSHORTCUTPAIR', 'DISPID_SVSLastBookmark',
    'DISPID_SPEs_NewEnum', 'SPEI_SR_BOOKMARK', 'DISPID_SpeechAudio',
    'SP_VISEME_10', 'IStream', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVGetProfiles',
    'SPCT_SUB_COMMAND', 'DISPID_SOTId', 'SDTAlternates',
    'SP_VISEME_19', 'DISPID_SRCEBookmark',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechGrammarWordType',
    'DISPID_SPRuleFirstElement', 'SRESoundStart',
    'SpeechSpecialTransitionType', 'DISPID_SPAsItem', 'SVEPrivate',
    'DISPID_SVVoice', 'SVP_17', 'SPSHT_Unknown', 'ISpRecoGrammar',
    'SpeechWordType', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRSAddRuleTransition', 'SREFalseRecognition',
    'DISPID_SRCESoundEnd', 'SPLO_STATIC',
    ...
    'SAFTADPCM_22kHzMono', 'SRSInactive', 'SPDKL_LocalMachine',
    'DISPID_SPCLangId', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRRSetTextFeedback',
    'DISPID_SGRSTType', 'eLEXTYPE_PRIVATE17', 'DISPID_SDKOpenKey',
    'typelib_path', 'SpeechTokenKeyFiles', 'DISPID_SWFEBitsPerSample',
    'SPPHRASEPROPERTY', 'DISPID_SpeechVoice', 'SLTApp',
    'SECNormalConfidence', 'DISPID_SRCCreateResultFromMemory',
    'SpeechVisemeFeature', 'SDKLCurrentUser', 'SLOStatic',
    'SpNullPhoneConverter', 'DISPID_SRCERequestUI', 'SPBINARYGRAMMAR',
    'SPPS_Modifier', 'SSFMCreate', 'ISpeechGrammarRules',
    'SPEI_RESERVED3', 'ISpNotifySource', 'DISPIDSPRG',
    'SVSFPersistXML', 'SGPronounciation', 'SRADefaultToActive',
    ...
    'DISPID_SADefaultFormat', 'SpCompressedLexicon', 'SASPause',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRSSupportedLanguages',
    'DISPID_SVSkip', 'SPCT_DICTATION', 'DISPID_SOTsItem',
    'ISpeechPhraseReplacements', 'SRADynamic'
]

_check_version('1.4.8', 1633528316.302569)
